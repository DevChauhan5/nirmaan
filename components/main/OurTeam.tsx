...
import { coreteam, scteam } from "@/constants";
              ...
              >
                <div className="relative overflow-hidden h-64">
                  <Image
                    ...
                    width={350}
                    height={350}
                    className="filter pointer-events-none grayscale group-hover:filter group-hover:grayscale-0 w-auto h-auto rounded-full transition duration-300"
                  />
                </div>
